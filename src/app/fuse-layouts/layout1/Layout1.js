				...
				<div id="fuse-layout" className={clsx(classes.root, config.mode, `scroll-${config.scroll}`)}>
					...
					<div className="flex flex-1 flex-col overflow-hidden relative">
						{config.toolbar.display &&
							...
							config.toolbar.position === 'above' &&!mailVerificationState&&  <ToolbarLayout1 />}
						...
						<FuseScrollbars className="overflow-auto" scrollToTopOnRouteChange>
							...
							<div className={classes.wrapper}>
								{config.navbar.display && config.navbar.position === 'left' && !mailVerificationState&& <NavbarWrapperLayout1 />}

								<div className={classes.contentWrapper}>
									{config.toolbar.display && config.toolbar.position === 'below' &&!mailVerificationState&& (
										<ToolbarLayout1 />
									)}
								...
								{config.navbar.display && config.navbar.position === 'right' &&!mailVerificationState&& (
		...
		default: {
			return (
				<div id="fuse-layout" className={clsx(classes.root, config.mode, `scroll-${config.scroll}`)}>
					...
					<div className="flex flex-1 flex-col overflow-hidden relative">
						{config.toolbar.display && config.toolbar.position === 'above' &&!mailVerificationState&& <ToolbarLayout1 />}
						...
						<div className={classes.wrapper}>
							...
							<div className={classes.contentWrapper}>
								{config.toolbar.display &&
									...
									config.toolbar.style === 'fixed' && !mailVerificationState&&<ToolbarLayout1 />}
								...
								<FuseScrollbars className={classes.content} scrollToTopOnRouteChange>
									...
									{config.footer.display &&
										...
										location.pathname!=='/pages/profile/profile' &&
										location.pathname!=='/pages/profile/business' &&
							...
							{config.navbar.display && config.navbar.position === 'right' &&!mailVerificationState&& <NavbarWrapperLayout1 />}
						</div>
					</div>
					<FuseMessage />
				</div>
