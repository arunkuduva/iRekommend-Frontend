...
function TermsAndConditionsContent(props) {
	...
	return (
		<div>			
			...
			<Typography className={classes.body} variant="body2">In this Terms and Conditions, “we”, “us”, “our” or “iRekommend” refers to iRekommend LLC. located at 6064 Cloverdale, Dr Tega Cay, South Carolina, 29708. "You", "your" or “Customer” means the person or entity using the Subscription Service or receiving the Consulting Services and identified in the applicable account record, billing statement, online subscription process, or Order Form as the customer.</Typography>

			<Typography className={classes.body} variant="body2">The Agreement relates to the website, including, but not limited to, the iRekommend product and iRekommend hosted/cloud service (taken together, the Website). The Website is owned and operated by iRekommend. The Website is subject to all of the terms and conditions contained in this Agreement and all other operating rules, policies (including, without limitation, iRekommend privacy policy) and procedures that may be published from time to time on this Site iRekommend.app.  We update these terms from time to time. If you have an active iRekommend product or service usage, we will let you know when we update the terms via in-app notification or by email. You can find archived versions of the Master Terms, Product Specific Terms, Jurisdiction Specific Terms & DPA.</Typography>
			...
			<Typography className={classes.body} variant="body2">This Agreement is a contract that governs your use of the iRekommend services. It consists of the following:</Typography>
			...
			<Typography className={classes.body} variant="body2">• 	Data Processing Agreement (DPA): This explains how we process your data and includes the EU Standard Contractual Clauses.
				Your Order Form is the iRekommend-approved form created following your purchase of one of our products or services through our online payment process or via in-app purchase. It contains all of the details about your purchase, including your term, products & services purchased and your fees. You’ll find your Order 		Form(s) in the Documents section of your iRekommend portal. We’ve aimed to keep these documents as readable as possible, but in some cases for legal reasons, some 	of the language is necessarily “legalese”. </Typography>
			...
			<Typography className={classes.body} variant="body2">"Customer Data" means all information that you submit or collect via the iRekommend Service. Customer Data does not include iRekommend Content. </Typography>
			...
			<Typography className={classes.body} variant="body2">“DPA” means the iRekommend Data Processing Agreement.</Typography>
			...
			<Typography className={classes.body} variant="body2">"iRekommend Content" means all information, data, text, messages, software, sound, music, video, photographs, graphics, images, and tags that we incorporate into the Subscription Service or Consulting Services, including Enrichment Data (as defined in the Product Specific Terms).</Typography>

			<Typography className={classes.body} variant="body2">"Order" or "Order Form" means the iRekommend-approved form or online subscription process by which you agree to subscribe to the Service and purchase iRekommend Consulting Services.</Typography>
			...
			<Typography className={classes.body} variant="body2">“Product and Services Catalog” means iRekommend’s Product and Services Catalog available at the website.</Typography>

			<Typography className={classes.body} variant="body2">“Product Specific Terms’ means the additional product-related terms that apply to your use of iRekommend products, our consulting services and Third party Services. These terms form part of the Agreement and can be found at the website.</Typography>

			<Typography className={classes.body} variant="body2">"Subscription Fees" means the amount you pay for the iRekommend Service excluding of all applicable taxes.</Typography>

			<Typography className={classes.body} variant="body2">"Subscription Service" means all of our web-based applications, tools and platforms that you have subscribed to under an Order Form or that we otherwise make available to you, and are developed, operated, and maintained by us, accessible via iRekommend.app or another designated URL, and any ancillary products and services, including website hosting, that we provide to you.</Typography>
			...
			<Typography className={classes.body} variant="body2">Additional Features. You may subscribe to additional features of the Subscription Service by placing an additional Order or activating the additional features from within your iRekommend account (if we make this option available.). This Agreement will apply to all additional Order(s) and all additional features that you activate from within your iRekommend account. </Typography>
			...
			<Typography className={classes.body} variant="body2">Notice of Non-Renewal. Unless otherwise specified in your Order, to prevent renewal of your subscription, you or we must give written notice of non-renewal. The deadline for sending this notice varies depending on the iRekommend product and edition you have subscribed to. For more information on non-renewal notice periods, please see the Product Specific Terms. If you decide not to renew, you may send this non-renewal notice to us by indicating that you do not want to renew.</Typography>
			...
			<Typography className={classes.body} variant="body2">Effect of Termination or Expiration. Upon termination or expiration of this Agreement, you will stop all use of the Subscription Service and iRekommend Content. If you terminate this Agreement for cause of material breach, we will promptly refund any prepaid but unused fees covering use of the Subscription Service after termination. If we terminate this Agreement for cause of material breach, you will promptly pay all unpaid fees due through the end of the Subscription Term. Fees which are otherwise non-refundable.</Typography>
			...
			<Typography className={classes.title} variant="h6">iRekommend OBLIGATIONS</Typography> 
			...
			<Typography className={classes.body} variant="body2">You acknowledge and agree that we may access and Process Personal Data on a global basis as necessary to provide the Subscription Service in accordance with the Agreement, and in particular that Personal Data will be transferred to and Processed by iRekommend. in India & US and to other jurisdictions where iRekommend Affiliates and Sub-Processors have operations. We will ensure such transfers are made in compliance with the requirements of Data Protection Laws.</Typography>
